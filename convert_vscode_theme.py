...
def convert_to_css(file_name: str) -> None:
    ...
    CSS_HEAD = f"""
/* 
 * Generated by Aard2 theme generator (created by Alexander Rusakevich)
...
""".strip() + (2*"\n")
    ...
    colors["a_color"]            = file_colors["textLink.foreground"]
    colors["a_color_active"]     = file_colors["textLink.activeForeground"]
    colors["a_color_visited"]    = file_colors["icon.foreground"]
